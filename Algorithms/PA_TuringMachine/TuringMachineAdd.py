...
def clear_output_file():
    with open('turingMachineAdd.txt', 'a') as output_file:
        output_file.seek(0)
...
def dump_output():
    ...
    length_of_file = len(open('turingMachineAdd.txt').readlines())
    if length_of_file < 30:

        # if so, write the file to the console
        with open('turingMachineAdd.txt', 'r') as output_file:
            print(output_file.read())
    else:
        print("task complete, see results in turingMachineAdd.txt")
...
if __name__ == '__main__':
    ...
    write_to_output("The larger number to add is: " + tape_big_val + " ("
                    + str(binary_to_number(tape_big_val, '#')) + ")")
    write_to_output("The smaller number to add is: " + tape_small_val + " ("
    ...
    ruleq6_01 = Rule('q6', '01', 'q6', '1', 2, -1)
    ruleq6_10 = Rule('q6', '10', 'q6', '1', 2, -1)
    ruleq6_11 = Rule('q6', '11', 'q7', '0', 2, -1)
    ruleq6_b0 = Rule('q6', '#0', 'q6', '0', 2, -1)
    ruleq6_0b = Rule('q6', '0#', 'q6', '0', 2, -1)
    ruleq6_b1 = Rule('q6', '#1', 'q6', '1', 2, -1)
    ruleq6_1b = Rule('q6', '1#', 'q6', '1', 2, -1)
    ruleq6_bb = Rule('q6', '##', 'qy', '#', 2, 1)

    ruleq7_00 = Rule('q7', '00', 'q6', '1', 2, -1)
    ruleq7_01 = Rule('q7', '01', 'q7', '0', 2, -1)
    ruleq7_10 = Rule('q7', '10', 'q7', '0', 2, -1)
    ruleq7_11 = Rule('q7', '11', 'q7', '1', 2, -1)
    ruleq7_b0 = Rule('q7', '#0', 'q6', '1', 2, -1)
    ruleq7_0b = Rule('q7', '0#', 'q6', '1', 2, -1)
    ruleq7_b1 = Rule('q7', '#1', 'q7', '0', 2, -1)
    ruleq7_1b = Rule('q7', '1#', 'q7', '0', 2, -1)
    ruleq7_bb = Rule('q7', '##', 'q6', '1', 2, -1)
